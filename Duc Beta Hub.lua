...
function library:CreateWindow(text,maincolor,text2,logo)
    ...
    Logo.Image = "rbxassetid://18861408627"..tostring(logo)
    ...
    ImageButton.Image = "rbxassetid://18861408627" -- LOGO
    ...
    function uitab:AddTab(text)
        ...
        function main:AddDropdown(text,option,callback)
			...
			DropImage.Image = "rbxassetid://18861408627"
...
--------------------------------------------------------------------
local RenUi = library:CreateWindow("Ducsharelink X ",Color3.fromRGB(0,255,255),"Blox Fruits")
-------------------------------------------------------------------
